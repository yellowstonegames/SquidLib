...
//            + "  gl_FragColor = vec4(step(3.5 * u_smoothing, distance * 0.75) * v_color.rgb, clamp((distance / (3.4 * u_smoothing)) + 0.9125, 0.0, 1.0) * v_color.a);\n"
    ...
    public static BitmapFont getSevenTwelveFont()
    {
        ...
        TextCellFactory.setAllFixedWidth(cpy);
        return cpy;
    }
    /**
    ...
    public static BitmapFont getOctagonalMonoFont()
    {
        ...
        final BitmapFont cpy = copyFont(instance.computerSaysNo);
        TextCellFactory.setAllFixedWidth(cpy);
        return cpy;
    }
    ...
    public static BitmapFont getCozyFont()
    {
        ...
        BitmapFont cpy = copyFont(instance.cozette);
        TextCellFactory.setAllFixedWidth(cpy);
        return cpy;
    }
    ...
    public static BitmapFont getCozyOutlinedFont()
    {
        ...
        BitmapFont cpy = copyFont(instance.cozetteOutlined);
        TextCellFactory.setAllFixedWidth(cpy);
        return cpy;
    }
