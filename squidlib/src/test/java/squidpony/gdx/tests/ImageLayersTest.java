...
public class ImageLayersTest extends ApplicationAdapter{
    ...
    public void create() {
        ...
        imagePanel = new ImageSquidPanel(gridWidth, gridHeight, layers.getTextFactory());
        imagePanel.setImageSwap('#', atlas.findRegion("brick-wall"));
        imagePanel.setImageSwap(',', atlas.findRegion("swamp"));
        imagePanel.setImageSwap('~', atlas.findRegion("big-wave"));
        imagePanel.setImageSwap('"', atlas.findRegion("grass"));
        imagePanel.setImageSwap('+', atlas.findRegion("wooden-door"));
        layers.setForegroundLayer(imagePanel);
