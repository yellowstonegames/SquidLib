...
public class FOVDemo extends ApplicationAdapter {
    ...
    public void putMap()
    {
        switch (fovType){
            case 0:
                ...
                break;
            case 1:
                FOV.reuseRippleFOV(resistance, visible, 1, player.x, player.y, 9.0, Radius.CIRCLE);
                break;
            case 2:
                FOV.reuseBurstFOV(resistance, visible, 1, player.x, player.y, 9.0, Radius.CIRCLE);
                break;
            case 3:
                FOV.reuseRippleFOV(resistance, visible, 2, player.x, player.y, 9.0, Radius.CIRCLE);
                break;
            case 4:
                FOV.reuseBurstFOV(resistance, visible, 2, player.x, player.y, 9.0, Radius.CIRCLE);
                break;
            case 5:
                FOV.reuseRippleFOV(resistance, visible, 3, player.x, player.y, 9.0, Radius.CIRCLE);
                break;
            case 6:
...
//        display.font.draw(batch, Gdx.graphics.getFramesPerSecond() + " FPS", screenPosition.x, screenPosition.y);
        batch.end();
        Gdx.graphics.setTitle("FOV Demo running at FPS: " + Gdx.graphics.getFramesPerSecond());
    }
