...
public class WeightedLetter {
    ...
    /**
     * Have the WeightedLetterGroup keep track of the next letter instead of a simple array. A simple array will do the
     * trick (removing the need for WightedLetterGroup or WeightedLetterCounter), if you use a different algorithm for
     * best-fitting the penultimate letter (see WeightedLetterNamegen.getIntermediateLetter()).
     *
     * @param nextLetter the letter to add
     */
