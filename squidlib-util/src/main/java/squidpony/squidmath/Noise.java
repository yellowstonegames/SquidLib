...
public class Noise {
     ...
     * the finalization step back.
     */
    public static final class LongPointHash
    {
        /**
...
//                    (((state += 0x6C8E9CD570932BD5L ^ v) ^ (state >>> 25)) * ((state ^ x) | 0xA529L))) >>> 58);
    ...
    /**
     * A group of similar methods for getting hashes of points based on long coordinates in 2, 3, 4, or 6 dimensions and
     * a long for state; like {@link LongPointHash} but optimized for speed rather than quality. This implementation has
     ...
     * instance). At low dimensions, this is a little faster than {@link LongPointHash}, but this class doesn't slow down
     * much at all as more dimensions are used, while LongPointHash and most other implementations do slow down.
     */
