/*
 * Copyright (c) 2009-2022  Eben Howard, Tommy Ettinger, and contributors
 *
...
//// Old version. It uses the Ziggurat method, as published by
//// Marsaglia and Tsang, 2000, in "The Ziggurat Method for Generating Random Variables";
//// <a href="http://www.jstatsoft.org/v05/i08/paper">pdf link</a>. The code here is a port from the
//// random number section of Go-Lang's experimental standard library.
//// Porting normal.go from https://github.com/golang/exp 
