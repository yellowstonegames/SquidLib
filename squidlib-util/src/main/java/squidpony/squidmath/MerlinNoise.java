...
//         return zm;
     ...
     * Does allow taking a seed because internally it uses a DiverRNG to quickly generate initial white noise before
     * processing it into more continuous noise. This generates a lot of random numbers (at least 1 + 14 * height, or
     * more if width is greater than 64), so DiverRNG's high speed and fairly good period are both assets here.
     * <br>
    ...
    public static int[][] preCalcNoise2D(int width, int height, long seed) {
        DiverRNG random = new DiverRNG(seed);
