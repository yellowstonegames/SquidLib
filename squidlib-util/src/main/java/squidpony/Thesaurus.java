...
//        Replacer rep = wordMatch.replacer(new SynonymSubstitution());
    ...
    public static final OrderedMap<String, ArrayList<String>> categories = makeOM(
            ...
            "shape`adj`",
            makeList("hollow", "tufted", "drooping", "fibrous", "giant", "miniature", "delicate", "hardy", "spiny", "thorny", "fragile", "sturdy", "long", "stubby", "stiff", "yielding", "ridged", "toothy", "ovate", "tattered", "crusty", "massive", "diminutive", "large", "small", "arched", "flat", "pored", "spongy"),
            "sensory`adj`",
            makeList("fragrant", "pungent", "rustling", "fuzzy", "glossy", "weeping", "rough", "smooth", "soft", "aromatic", "spotted", "striped", "shaggy", "feathery", "hairy", "furry", "scaly"),
            "liquid`noun`",
