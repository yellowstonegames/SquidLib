...
public class EditRNGTest {
    ...
    public static void d20GraphCurved(PintRNG rng, String description)
    {
        ...
        for (int i = 0; i < 1000; i++) {
            rolls.get(Math.round(NumberTools.formCurvedFloat(rng.nextInt()) * 10) + 10).append('*');
        }
    ...
    public static void main(String[] args) {
        ...
        PintRNG source = new PintRNG(0xBEEF);
