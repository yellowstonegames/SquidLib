...
public class RNGTest {
    ...
    public static void main(String[] args)
    {
        ...
        for(int i = 0; i < 99; i++)
        {
            ...
            l = lrr.nextLong();
            /*System.out.println("LRR : " + */ binaryString(l, 7);
            l = prr.nextLong();
            /*System.out.println("PRR : " + */ binaryString(l, 8);
            l = xrr.nextLong();
            /*System.out.println("XRR : " + */ binaryString(l, 9);
            l = drr.nextLong();
            /*System.out.println("DRR : " + */ binaryString(l, 10);
            l = ir.nextLong();
            /*System.out.println("IR  : " + */ binaryString(l, 11);
            l = irr.nextLong();
            /*System.out.println("IR  : " + */ binaryString(l, 12);
            l = lpr.nextLong();
            /*System.out.println("LPR : " + */ binaryString(l, 13);
            l = lprr.nextLong();
            /*System.out.println("LPR : " + */ binaryString(l, 14);
            l = xnr.nextLong();
