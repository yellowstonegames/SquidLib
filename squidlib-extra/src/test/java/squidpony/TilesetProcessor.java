...
public class TilesetProcessor extends ApplicationAdapter {
    ...
    public void create() {
        ...
        for(String js : jss)
        {
            ...
            appendln(java, "package com.github.yellowstonegames.place.tileset;");
            appendln(java, "");
...
//            appendln(java, "");
            ...
            try {
                initializeTopLevel(java, "config", ts.config);
//                initalizeTopLevel(java, "max_tiles", ts.max_tiles, ts);
    ...
    private static void initializeTileArray(StringBuilder java, String fieldName, OldTile[] ts_tiles) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            java.append("    ,").append(gr.serializeToString()).append(");").append('\n');
        }
    }

    private static void initializeTopLevel(StringBuilder java, String fieldName, OldConfig c)
