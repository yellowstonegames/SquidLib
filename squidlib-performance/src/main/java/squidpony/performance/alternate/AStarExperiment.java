...
/**
 * Created by Tommy Ettinger on 11/29/2016.
 */
public class AStarExperiment  implements Serializable {
     ...
     */
    public AStarExperiment(double[][] map, SearchType type) {
        if (map == null)
